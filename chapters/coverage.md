...
| bhamaha | Ch 46 | Ch 46 §4.1 (⭐⭐ **collision #13 — and the corpus's own rule predicted the specialist's verdict**) · Ch 46 §4.2 (⚠ the rule against arguments from silence narrowed: a scalpel, not a broom) · Ch 46 §3.1–3.2 (⚠⚠ **the node was corrected within its own batch** — "lost" commentary re-read as a terminus, and what that cost and bought) — **contested** |
| sauraseni | Ch 46 | Ch 46 §3 (⭐⭐⭐ **the same gap read twice**: Cowell's loss vs Ollett's terminus, decided by an 11th-c. witness) · Ch 46 §2.3 (⭐ why the three chapters were added — Rudraṭa's sixfold schema, and the corpus's own mechanism superseded) · Ch 46 §6 (⭐⭐ **Jain Śaurasenī = the Digambara doctrinal language**, and the §0 warning that travels with the fact) — **contested** |
| durgasimha | Ch 46 | Ch 46 §4.4 (⭐⭐ **an attribution caught happening between two manuscripts** — Poona anonymous, India Office naming him; and the flag this puts on Ch 44 §7's T4 census) · Ch 46 §4.5 (royal patrons doing the work of divine ones) — **contested**, confidence **low** |
| vyadi | Ch 47 | Ch 47 §1.1 (⚠⚠ **the Dākṣāyaṇa argument treats a patronymic as if it individuated a person** — the node written second weakens the node written first) · Ch 47 §6 (⭐⭐ the lost *Saṅgraha*, and the *Vākyapadīya* epilogue read at first hand: *saṃgrahe 'stam upāgate*) · Ch 47 §9 (Abhyankar dating him twice, incompatibly; and the wisdomlib=Abhyankar trap now **proven** by the site's own attribution line) — **contested** |
| sakatayana | Ch 47 | Ch 47 §1 (⭐⭐⭐ **the eighth collision generator — the patronymic**, and it is nobody's mistake: MW glosses the name as a patronymic, the *Purāṇa Index* as a *pravara* of the Bhārgavas) · Ch 47 §1.2 (the scale of what a name is evidence for) — **contested** |
| sakatayana-jain | Ch 47 | Ch 47 §8 (⭐⭐⭐ **the entire surviving literature of the Yāpanīya sect is four works by one grammarian**) · Ch 47 §8.1 (⭐ each surviving sect assigns the third one to its rival; the *Śrutakevalideśīya* colophon, and two disciplines converging on it without citing each other) · Ch 47 §8.2 (⚠⚠ **the §0 guard taken from inside the source** — Goldman on "a theory of ancient India as a place of social and gender equality"; Batch 50's charter question now has two cases) · Ch 47 §10 (⚠ **no Yāpanīya node**) — **contested** |
| devanandin | Ch 47 | Ch 47 §2 (⭐⭐⭐ **58 files cite Pūjyapāda, 2 cite Devanandin, 0 join them — they are one man**) · Ch 47 §2.1 (⭐⭐ **how it happened: a table is a lossy format, and what it loses is whatever is not one of its columns**) · Ch 47 §3 (⚠⚠ **collision #17** — two grammarians named Jinendrabuddhi, each with a *Nyāsa*) — **contested** |
| jainendra-vyakarana | Ch 47 | Ch 47 §7 (⭐⭐ **a counted census: 32 mentions in Abhyankar, 28 of them a term the Jainendra REPLACED** — including *vṛddhi*, the term of P. I.1.1) · Ch 47 §7.1 (⭐⭐ **qualifies Ch 44's T4**: what crosses system boundaries is the technique, not the terminology) · Ch 47 §7.2 (⚠ the sectarian reading refused) — **contested** |
| candrakirti | Ch 47 | Ch 47 §5 (⭐⭐⭐ **"Prāsaṅgika"/"Svātantrika" are 12th-c. TIBETAN labels**, and the corpus taught them as 7th-c. Indian schools) · Ch 47 §5.1 (⭐⭐ **and it already knew, in `santaraksita.md`**) · Ch 47 §5.2 (⚠ in India he was not influential for three centuries and was never translated into Chinese) · Ch 47 §5.3 (⚠ a striking claim gone looking for and **refused**) · Ch 47 §9 items 5–6 (⛔ the *Bodhicaryāvatāra* misattribution and the false internal citation) — **contested** |
| maitreya-raksita | Ch 47 | Ch 47 §4 (⚠⚠ **a religion inferred from a name**, hedged twice by Abhyankar and repeated unhedged by the corpus) · Ch 47 §4.1 (⭐ the objection is in the same entry: his citers avoided the compound form) · Ch 47 §4.2 (⭐⭐⭐⭐ **the corpus's catalogue of a habit turns out to describe its own principal modern source**) · Ch 47 §6 (⭐⭐⭐ **a source out of date rather than wrong** — the "fragmentary" *Tantrapradīpa* printed in full in 2007 from a 220-folio Coochbehar manuscript) · Ch 47 §6.1 (⭐ **the eastern school drawn as a five-tier, five-century lineage** for the first time) — **contested** |
