...
*`vagbhata` and `dhatu`/`mala` are **unwritten concept nodes** in `progress.md`'s batch queue. If they are written, this chapter should be revisited — the third classical authority is currently a hole in it.*
