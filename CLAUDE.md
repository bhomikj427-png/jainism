...
- After any bulk work, run `python graph/find_duplicates.py` **and** `python graph/check_chapters.py`; a non-zero exit from either is a defect to resolve under §10 before pushing.
